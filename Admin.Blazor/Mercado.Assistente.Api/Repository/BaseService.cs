...
namespace Ma.Service
{
    public class BaseService<T> : IService<T> where T : BaseEntity
    {
        ...
        public void SetMaContext(MaContext MaContext)
        {            
             repository = new BaseRepository<T>(MaContext);
        }

        public BaseService(MaContext Context)
        {
        ...
        public BaseService()
        {
            var context = new MaContext(MakeContextOptions.Build().Options);
            repository = new BaseRepository<T>(context);
        }
