...
namespace Ma.MercadoAssistente.Api.Contexto
{
    public partial class MaContext : DbContext
    {
        ...
        public MaContext(DbContextOptions options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=191.252.191.144;port=9684;Database=MercadoVarejo;Username=andreluc;Password=f@5f!le3TsMqu");
            }
        }
